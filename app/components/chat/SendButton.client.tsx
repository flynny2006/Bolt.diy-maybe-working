...
export const SendButton = ({ show, isStreaming, disabled, onClick }: SendButtonProps) => {
  return (
    <AnimatePresence>
      {show && (
        <motion.button
          className="absolute flex justify-center items-center top-[18px] right-[22px] p-1 bg-accent-500 text-white rounded-xl w-[40px] h-[40px] shadow-lg hover:shadow-xl transition duration-200 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed"
